...
$category_id = isset($_GET['categoryid']) ? $_GET['categoryid'] : 1;
...
$subcateq = mysqli_query($connect, "SELECT * FROM tbl_subcategory WHERE category_id = $category_id");

// Fetch all products in the selected category (ignoring subcategories)
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-lg-9 product-listing">
                <div class="product-header">
                    <h1 id="category-title"><?php echo $category_name; ?></h1>
                    <p class="category-description">Browse our latest <?php echo $category_name; ?> products</p>
                </div>
